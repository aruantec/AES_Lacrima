...
/// </summary>
internal static class GameplayRecordingFrameComposer
{
        ...
        int outputHeight)
    {
        ...
        var info = new SKImageInfo(sourceWidth, sourceHeight, SKColorType.Bgra8888, SKAlphaType.Premul);
...
internal sealed class GameplayRecordingFrameWorker : IDisposable
{
    private readonly object _snapshotLock = new();
    private readonly AutoResetEvent _frameReady = new(false);
    private Thread? _thread;
    private volatile bool _running;
    private RecordingSnapshot? _pendingSnapshot;
    ...
    public void Start()
    {
        ...
        {
            IsBackground = true,
            Name = "GameplayRecordingCompositor",
    ...
    private void WorkerLoop()
    {
        while (_running)
        {
            ...
            try
            {
                var pixels = GameplayRecordingFrameComposer.ComposeGameContentFrame(
                    snapshot.Source,
